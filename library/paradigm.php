...
function bones_scripts_and_styles() {
  ...
  if (!is_admin()) {
		...
		wp_register_script( 'paradigm-js', get_stylesheet_directory_uri() . '/library/js/min/scripts.min.js', array( 'jquery' ), '', true );
		...
		$wp_styles->add_data( 'paradigm-ie-only', 'conditional', 'lt IE 9' ); // add conditional wrapper around ie stylesheet
